...
class Config(object):
    ...
    def __init__(self):
        ...
        self.train_dir_list = [
            # "/data1/wyj/M/datasets/MoNuSAC/masks-new"
            # "/data1/wyj/M/datasets/MoNuSAC/HV0/masks-new"
            '/data1/wyj/M/datasets/consepcrop/Train/'
        ]
        self.valid_dir_list = [
            '/data1/wyj/M/datasets/consepcrop/Test/'
            # "/data1/wyj/M/datasets/MoNuSAC/valid"
            # "/data1/wyj/M/datasets/MoNuSAC/HV/masks-new-valid"
        ]
